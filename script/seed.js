...
async function seed() {
  ...
  const hues = await Promise.all([
    Hue.create({
      ...
      emotionHue: '#283618',
      image: `public/images/hues/petrichor.png`,
      description:
    ...
    Hue.create({
      emotionName: 'Dès Vue',
      emotionHue: '#aa767c',
      image: `public/images/hues/des-vue.png`,
    ...
    Hue.create({
      ...
      emotionHue: '#a4161a',
      image: `public/images/hues/kairosclerosis.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#ffcdb2',
      image: `public/images/hues/vemodalen.png`,
    ...
    Hue.create({
      ...
      emotionHue: '#b5838d',
      image: `public/images/hues/harmonia.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#eec170',
      image: `public/images/hues/liberosis.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#87a330',
      image: `public/images/hues/nikhedonia.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#ba6a49',
      image: `public/images/hues/euneirophrenia.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#a56336',
      image: `public/images/hues/dolce-far-niente.png`,
    ...
    Hue.create({
      emotionName: 'Ambedo',
      emotionHue: '#ffedd8',
      image: `public/images/hues/ambedo.png`,
    ...
    Hue.create({
      emotionName: 'Suente',
      emotionHue: '#718355',
      image: `public/images/hues/suente.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#6d3b47',
      image: `public/images/hues/amoransia.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#d55d92',
      image: `public/images/hues/hubilance.png`,
      description:
    ...
    Hue.create({
      emotionName: 'Ledsome',
      emotionHue: '#18435a',
      image: `public/images/hues/ledsome.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#fbb3a5',
      image: `public/images/hues/etterath.png`,
      description:
    ...
    Hue.create({
      emotionName: 'Galagog',
      emotionHue: '#ffb200',
      image: `public/images/hues/galagog.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#3891a6',
      image: `public/images/hues/whipgraft-delusion.png`,
      description:
    ...
    Hue.create({
      ...
      emotionHue: '#c05c35',
      image: `public/images/hues/apolytus.png`,
      description:
